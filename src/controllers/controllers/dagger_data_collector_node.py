...
class DaggerDataCollectorNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Bool, '/expert_active', self.expert_active_cb, 10)

        self.latest_scan = None
        self.latest_odom = None
        self.latest_cmd = Twist()
        self.expert_active = False  # Only active when expert takes over
        ...
        self.get_logger().info(
            f'DAgger DataCollector ready — Expert {self.expert_id} | '
    ...
    def expert_active_cb(self, msg: Bool):
        self.expert_active = msg.data
