...
from scripts.dataset import DaggerDataset
...
def main():
    ...
    parser.add_argument('--datasets', nargs='+', default=['expert_999', 'dagger_1'], help='List of dataset folders to include')
    ...
    print("=============================================")
    print(" MEGA-DAgger Iterative Training Pipeline")
    print("=============================================")
    ...
    full_dataset = dataset_builder.load_data()
    ...
    plt.title('MEGA-DAgger Training Loss')
    plt.xlabel('Epoch')
    plt.ylabel('MSE Loss')
    plt.legend()
